...
class orderitemCallService
{
    ...
    public  static  function updateOrderitem($array)
    {
        $service_url = self::URL . "/orderitems/update";
        $curl = curl_init($service_url);
        curl_setopt($curl, CURLOPT_RETURNTRANSFER, true);
        curl_setopt($curl, CURLOPT_POST, true);
    ...
    public  static  function deleteOrderitem($array)
    {
        $service_url = self::URL . "/orderitems/delete";
        $curl = curl_init($service_url);
        curl_setopt($curl, CURLOPT_RETURNTRANSFER, true);
        curl_setopt($curl, CURLOPT_POST, true);
    ...
    public  static  function getAllOrderitem()
    {
        $curl = curl_init(self::URL . "/orderitems");
        curl_setopt($curl, CURLOPT_RETURNTRANSFER, true);
        $curl_response = curl_exec($curl);
        if ($curl_response === false) {
            $info = curl_getinfo($curl);
